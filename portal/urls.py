...
from portal import views  # <--- Questa è la riga corretta che risolve l'ImportError

urlpatterns = [
    # Pannello di amministrazione Django standard
    path("admin/", admin.site.urls),

    # Logiche dell'applicazione portal
    ...
    # Completa profilo e attivazione
    path("complete-profile/", views.complete_profile, name="complete_profile"),
    path("activate/<uidb64>/<token>/", views.activate_account, name="activate_account"),

    # Sezione Admin personalizzata
...
path("admin-confirm-import/", views.admin_confirm_import, name="admin_confirm_import"),
    ...
    # Reset Password (utilizza i template in registration/)
    path(
        "password-reset/",
