...
from portal import views  # Importa correttamente dall'app portal

urlpatterns = [
    # Pannello di amministrazione Django
    path("admin/", admin.site.urls),

    # Home e logiche principali del portale
    ...
    # Gestione profilo e attivazione
...
# Serve i file media in modalità debug
if settings.DEBUG:
